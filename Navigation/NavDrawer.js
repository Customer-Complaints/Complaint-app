...
export function NaviBottomTab({ navigation }) {
    return (
        <View style={styles.navcontainer}>
            <View style={styles.navicons}>
                ...
                <TouchableOpacity
                    onPress={() => navigation.navigate("ComplaintsDisplayPage")}
                >
                    <View style={{ alignItems: "center" }}>
                        <Ionicons name="newspaper" size={20} color="#808080" />
                        <Text>Complaints</Text>
                    </View>
                </TouchableOpacity>

                <TouchableOpacity
                    onPress={() => navigation.navigate("Rate&ComplainPage")}
                >
                    <View style={{ alignItems: "center" }}>
